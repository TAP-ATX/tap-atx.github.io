  ...
  return (
    <Container className="info-container">
      <div className="description-container">
        ...
        <p>
          <strong>TAP-ATX’s Mission</strong> is to connect, grow, and empower the greater Austin community by providing
          quality resources and programs influenced by the Taiwanese American perspective.
        </p>

        <img src={OfficerImg} alt="tap_officers" />

        <p>
          TAP-ATX is a chapter of TACL National, a 501c3 non-profit organization run entirely by volunteers. Learn more
          about{" "}
        ...
        <h4>Key Values</h4>
        <ul>
          <li>Build Taiwanese American community-oriented leaders in all professions</li>
          ...
          <li>Become a bridge for TAP members and other Taiwanese American and Asian Pacific American organizations</li>
        </ul>
      </div>
    </Container>
  )
