    ...
    <div className="footer">
      <Container className="footer__social">
        <Row>
          <Col className="text-center">
            ...
            <a
              href="https://twitter.com/tap_atx"
              rel="noreferrer"
              target="_blank"
            >
      ...
      <Container className="footer__copyright">
        <p className="text-center">
          © {year} TAP-ATX. All rights reserved. A 501(c)(3) organization for
          the Taiwanese American community in Austin, TX.
        </p>
      </Container>
    </div>
  );
